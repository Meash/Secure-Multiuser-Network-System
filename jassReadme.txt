...
2. To build the 2 .jar files:
   ...
   and:
     jar -cvf JAASExample.jar LoginClient.class LoginClientCallbackHandler.class KeyFetcherTest.class3. 
...
java -classpath src/:JAASExample.jar:Simple.jar -Djava.security.auth.login.config=smns.config LoginClient
